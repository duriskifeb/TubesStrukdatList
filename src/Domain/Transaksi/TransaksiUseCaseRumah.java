...
public class TransaksiUseCaseRumah {
    ...
    public void createInitialTransaksi(Date startDate, Date endDate, String nik, User pegawai, String noKamar,
            Pembayaran payment) {
    ...
    public void bayar(AppEnums.Pembayaran metodeBayar, double amountBayar) {
        ...
        if (metodeBayar == Pembayaran.CASH) {
            ...
            // sisatagihan = //Math.abs(currentActiveTransaksi.getPaid() + (amountBayar -
            // yangHarusDibayarkan));
            if (kembalianPembayaran < 0) {
                ...
                sisatagihan = kembalianPembayaran;// currentActiveTransaksi.getTotal() -
        ...
        if (currentActiveTransaksi.getPaid() > 0
                && currentActiveTransaksi.getPaid() > currentActiveTransaksi.getTotal()) {
            // lunas
